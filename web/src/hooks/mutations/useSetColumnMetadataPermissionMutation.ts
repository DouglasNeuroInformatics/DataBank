...
export function useSetColumnMetadataPermissionMutation({ isProject }: { isProject: boolean }) {
  ...
  return useMutation({
    ...
    }) => axios.patch(`/v1/datasets/column-metadata-permission/${datasetId}/${columnId}`, { permission }),
    onSuccess() {
